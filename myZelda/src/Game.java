...
Tile based game that creates a unique new world based on the random number generator seed
that is entered by the user, i.e. each unique seed will produce a unique world.
Each world contains a dungeon structure that changes drastically
and a temple structure that changes it's size and location.
...
public class Game implements Serializable {
    ...
    private final int windowHeight = 46;  //4 is max for my laptop.
    TETile[][] world;
